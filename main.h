...
#define EXIT_DESC								\
	...
	"\0"
#define HELP_HELP "help [MAIN]"
#define HELP_DESC								\
	"Display information about main commands.\n\0"			\
	"If MAIN is omitted, the available commands are displayed.\0"	\
	"\0"
...
#define UNSETENV_DESC								\
	...
	"\0"
typedef int (*main_fp)(info_t *);

/**
 *  * struct main - main command
 *   * @name: command name
 *    * @f: function to call
 *     * @help: command usage
...
const struct maiin *get_main(const char *name);
const struct main *get_mains(void);
